    ...
    <div className="relative">
      ...
      {localValue && (
        <button
          onClick={handleClear}
          aria-label="清除搜索"
          className="absolute right-2.5 top-1/2 -translate-y-1/2 p-1 rounded-md text-[var(--text-tertiary)] hover:text-[var(--text-secondary)] hover:bg-[var(--hover-bg)] transition-colors"
        >
